module.exports = class {
  ...
  async getAllReports(req, res) {
    const Order = require("../../services/order/getAllReports");
    const order = new Order();
    await order.getAllReports(req, res);
  }
  async replyReport(req, res) {
    const Order = require("../../services/order/replyReport");
    const order = new Order();
    await order.replyReport(req, res);
  }
  ...
  async report(req, res) {
    const Order = require("../../services/order/report");
    const order = new Order();
    await order.report(req, res);
  }
  async rate(req, res) {
