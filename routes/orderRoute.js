...
Router.post("/report", (req, res) => order.report(req, res));
Router.get("/getAllReports", (req, res) => order.getAllReports(req, res));
...
Router.post("/replyReport", (req, res) => order.replyReport(req, res));
// replyReport
Router.post("/orderPayUpdating", (req, res) =>
  order.orderPayUpdating(req, res)
);
